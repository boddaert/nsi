...
Exécuter à la main l'algorithme du parcours en profondeur d'abord sur les arbres de l'application $3$ en dessinant les files sur feuille.
...
a) Exécuter à la main l'algorithme itératif du parcours en profondeur d'abord sur le premier arbre de l'application $3$ en dessinant les files sur feuille.
